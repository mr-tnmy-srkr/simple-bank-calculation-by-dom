document.getElementById("btn-deposit").addEventListener("click", function () {
  ...
  const newDepositAmount = parseFloat(
    parseFloat(newDepositAmountStr).toFixed(2)
  );
  ...
  const currentDepositTotal = parseFloat(
    (newDepositAmount + newPreviousDepositTotal).toFixed(2)
  );
  ...
  const currentBalanceTotal = parseFloat(
...
document.getElementById("btn-withdraw").addEventListener("click", function () {
  ...
  const newWithdrawAmount = parseFloat(
    parseFloat(newWithdrawAmountStr).toFixed(2)
  );
  ...
  const currentWithdrawTotal = parseFloat(
    parseFloat(previousWithdrawTotal + newWithdrawAmount).toFixed(2)
  );
  withdrawTotalElement.innerText = currentWithdrawTotal.toFixed(2);

  const currentBalanceTotal = parseFloat(
    parseFloat(previousBalanceTotal - newWithdrawAmount).toFixed(2)
  );
  balanceTotalElement.innerText = currentBalanceTotal.toFixed(2);
});
